// MaintenanceManagementProjects.tsx
...
// Data Structure Mapping All 3 Maintenance Management Project Configurations
const projectsData = [
  {
    title: "LNG Maintenance Management System Implementation",
    location: "Sabine Pass & Enterprise Facilities, USA",
    image: import.meta.env.BASE_URL + "image28.png",
    description:
      "Long-term structural consultation contract to architect, build, and deploy an enterprise asset maintenance management strategy for two flagship LNG liquefaction complexes. Program execution uses IBM's Maximo software platform to comprehensively standardize critical component maintenance, repairable spares workflows, and turnarounds.",
    equipment: [
      "Liquefaction Train Assemblies",
      "Gas Turbines & Interchanged Rotables",
      "Pressure Safety Valves (PSVs)",
      "PCMS RBI Analytical Platforms",
      "IBM Maximo Asset Register Matrix",
      "Supply Chain Integrated Inventories",
    ],
    services: [
      "Maintenance Management Philosophy",
      "Asset Register & Bill of Material (BOM)",
      "PM / Corrective Plans & Procedures",
      "Maximo Regulatory Audit Compliance Linking",
      "Routine & Turnaround Scheduling Support",
    ],
  },
  {
    title: "Gas Processing Facility Maintenance Management System",
    location: "Reeves County, TX, USA",
    image: import.meta.env.BASE_URL + "image28.png",
    description:
      "Strategic system design, configuration, and data load deployment of an asset maintenance architecture for a highly scaled gas processing and compression operation. Built using SAP PM modules integrated with real-time field-to-office sync mechanisms to manage expanding regional gathering systems.",
    equipment: [
      "Cryogenic Gas Processing Units",
      "Field Compression Stations",
      "SAP PM Database Systems",
      "SAP Mobile Work Manager (Agentry)",
      "Ruggedized iPad Field Hardware",
      "Mobile Barcode Scanning Systems",
    ],
  },
  {
    title: "MMS Implementation & Procedure Development",
    location: "Multiple Processing Facilities, USA",
   image: import.meta.env.BASE_URL + "image28.png",
    description:
      "Enterprise Maximo integration program deployed concurrently across approximately twenty-five independent gas processing assets for a major midstream provider. Scope features location hierarchy redesign alongside standardized operations manual execution to optimize field-level visibility.",
    equipment: [
      "25 Midstream Processing Plants",
      "P&ID Operational Hierarchies",
      "Asset Criticality Categorizations",
      "Enterprise IBM Maximo Framework",
      "LOTO Isolation Station Assemblies",
      "Central Data Loading Repositories",
    ],
  },
];

export default function DataManagmentProject() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans antialiased selection:bg-[#0B6C98] selection:text-white">
      ...
      <section className="relative w-full h-[600px] bg-slate-950 flex items-center overflow-hidden">
        <img
          ...
          alt="Maintenance Management Systems Engineering"
